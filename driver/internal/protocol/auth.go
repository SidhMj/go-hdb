...
// NewAuthHnd creates a new Auth instance.
func NewAuthHnd(logonname string) *AuthHnd {
	return &AuthHnd{logonname: logonname, methods: authMethods{}}
}
...
func (a *AuthHnd) Method() auth.Method { return a.method }
...
func (a *AuthHnd) InitReply() (*AuthInitReply, error) { return &AuthInitReply{auth: a}, nil }
